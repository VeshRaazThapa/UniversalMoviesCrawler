...
# foo_list= 'spam spam spam spam smefood spam'.split()
# print(foo_list)
# food_count = defaultdict(int)
# print(food_count)
# for food in foo_list:
#     food_count[food]+=1
#     print(food_count)
# ice_cream = defaultdict(bool)
# ice_cream['chunky'] = 'dark chocolate'
# ice_cream['monkey'] = 'white'
# for key in ice_cream:
#     print(key)
# print(ice_cream)
# # print(ice_cream['pandit'])
# cities_list = [('nz','busy'),('nb','busybess'),('na','moderndays'),('nb','someday')]
# cities_by_state = defaultdict(list)
# for state,city in cities_list:
#     cities_by_state[state].append(city)
# for state,city in cities_by_state.iteritems():
